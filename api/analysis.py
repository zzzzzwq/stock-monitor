...
def analysis_summary():
    ...
    return jsonify({
        ...
        "total_pnl": total_pnl,
        "tech_data": {k: {
            "ma_status": v.get("ma_status", ""),
            "bias": v.get("bias", ""),
            "rsi": round(v.get("rsi", 0), 1),
            "support": round(v.get("support", 0), 1),
            "resistance": round(v.get("resistance", 0), 1),
            "macd_trend": v.get("macd", {}).get("trend", ""),
